...
<section class="u-align-center u-clearfix u-section-1" id="carousel_a803">
      ...
      <c:if test="${not empty payOrderSuccess}">
        ...
        <h2 class="u-align-center u-custom-font u-text u-text-font u-text-1"> FlowerShop Items</h2>
        <p class="u-align-center u-text u-text-2" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction=""> You may view our product list and add to cart chosen items. Also you may use the search form to find all product you need.</p>
